...
public class Gate implements Encodable {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            // two objects are same the instance of Gate
            return true;
        } else if (!(obj instanceof Gate)) {
            // obj is not an instance of Gate
            return false;
        } else {
            // check whether two objects have same gate number
            Gate gate = (Gate) obj;
            return this.getGateNumber() == gate.getGateNumber();
        }
    }
     ...
     */
    public int hashCode() {
        return this.getGateNumber() * 11 + 7;
    }
    ...
    public String encode() {
        String result = this.getGateNumber() + ":";
        if (this.isOccupied()) {
            return result + this.getAircraftAtGate().getCallsign();
        } else {
            return result + "empty";
        }
    }
